  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to E-Commerce, accessible from{" "}
            <a
              href="https://next-gcp-ecommerce-981674263788.asia-east1.run.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://next-gcp-ecommerce-981674263788.asia-east1.run.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: heyu880202@gmail.com</li>
      </ul>
    </>
  );
}
